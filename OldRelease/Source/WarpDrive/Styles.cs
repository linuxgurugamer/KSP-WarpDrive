...
namespace WarpDrive
{
	internal class Styles
	{
		...
		internal static void InitStyles()
		{
			...
			window.contentOffset = new Vector2(0f, -22f);
			window.fontSize = 14;
			...
			verticalSliderThumb.fixedWidth = 13f;
			verticalSliderThumb.fixedHeight = 30f;
			...
			horizontalScrollbar.fixedHeight = 19f;
			...
			horizontalScrollbarThumb.fixedHeight = 15f;
			...
			verticalScrollbar.fixedWidth = 19f;
			...
			verticalScrollbarThumb.fixedWidth = 15f;
